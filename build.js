...
// Files to process
const HTML_FILES = ['index.html', 'dashboard.html', 'upload.html', 'admin.html', 'fechamento.html'];
const JS_FILES = ['supabase-config.js', 'tenant.js', 'auth.js', 'dashboard.js', 'upload.js', 'admin.js', 'fechamento.js'];
